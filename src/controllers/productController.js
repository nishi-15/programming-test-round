...
var Products_1 = __importDefault(require("../modules/Products"));
var createProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Products_1.default.create(req.body)];
            case 1:
                product = _a.sent();
...
var updateProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, updatedProduct, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, Products_1.default.findByIdAndUpdate(id, req.body, { new: true })];
            case 1:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, Products_1.default.findByIdAndDelete(id)];
            case 1:
                _a.sent();
